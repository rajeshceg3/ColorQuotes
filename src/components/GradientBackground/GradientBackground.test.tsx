...
const mockGradients = [
  { type: "linear", direction: "bg-gradient-to-br", colors: ["from-pink-300", "to-purple-300"] },
  { type: "linear", direction: "bg-gradient-to-r", colors: ["from-green-200", "to-blue-200"] },
  { type: "linear", direction: "bg-gradient-to-t", colors: ["from-yellow-200", "to-red-200"] },
];
